"""
Django settings for alimentoSantiago project.
...
ROOT_URLCONF = 'alimentoSantiago.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ecommerce.procesadorContexto.carro',
            ],
        },
    },
]

WSGI_APPLICATION = 'alimentoSantiago.wsgi.application'
...
#se instanciara mas adelante para las autenticaciones
#LOGIN_REDIRECT_URL = '/'
#LOGIN_URL = '/iniSesion'